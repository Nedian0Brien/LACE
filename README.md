...
`S0: semantic skeleton extraction and preservation validation`, `S1: skeleton-use controls`, `S2: skeleton-to-text reconstruction`은 완료됐다. 다음 실험은 `S3: anchor baseline comparison`이다.
